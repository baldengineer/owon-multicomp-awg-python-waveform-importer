...
The direct-control mode is currently at the initial connection stage. The included
script opens a TCP socket, sends `*IDN?`, and prints the instrument identification.
